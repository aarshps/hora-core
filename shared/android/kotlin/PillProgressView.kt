...
class PillProgressView @JvmOverloads constructor(
    ...
    var progressColor: Int = __HORA_PKG__.util.ThemeHelper.getPrimaryColor(context)
        set(value) {
            field = value
            invalidate()
        }
    ...
    var trackColor: Int = __HORA_PKG__.util.ThemeHelper.getSurfaceVariantColor(context)
        set(value) {
            field = value
